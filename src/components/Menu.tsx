...
export default function Menu (): ReactElement {
  ...
  return (
    <ul className='menu menu-horizontal justify-center bg-gray-200 shadow-lg rounded-box absolute top-16 slide-in'>
      <li>
        <button data-tip='Outfits' className={`tooltip active:bg-gray-200 ${OUTFIT_ICON_ID === configId ? 'w-full h-full bg-gray-800 active:text-white active:bg-gray-800 text-gray-100' : 'text-gray-500'} `} onClick={() => setConfigId(OUTFIT_ICON_ID)}>
      ...
      <li>
        <button data-tip='Accessories' className={`tooltip  active:bg-gray-200 ${ACCESORY_ICON_ID === configId ? 'bg-gray-800 active:text-white active:bg-gray-800 text-gray-100' : 'text-gray-500'}`} onClick={() => setConfigId(ACCESORY_ICON_ID)}>
      ...
      <li>
        <button data-tip='Regenerate' className='tooltip hover:bg-gray-300 active:bg-gray-200' onClick={() => setIllustrationsIDList(mapDetailsToSvg(detection))}>
      ...
      />
      <li>
        <button data-tip='Delete' className='tooltip active:bg-gray-300' onClick={() => resetIllustrations()}>
