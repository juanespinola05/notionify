...
export function useDetection (): any {
  ...
  const setDetection = (detectionObject: CloudinaryDetectionResponse, betaFace: BetaFaceAPIResponse): void => {
    ...
    const face = betaFace.media.faces[0]
    if (face === undefined || data === undefined) {
